...
let allowedOrigins = ['http://localhost:1234', 'https://myflixjs.netlify.app', 'http://localhost:8080', 'https://movieapi-dcj2.onrender.com/', 'http://testsite.com']; // list of allowed domains
app.use(cors({
