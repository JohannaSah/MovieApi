...
let allowedOrigins = ['http://localhost:1234', 'http://localhost:4200', 'https://myflixjs.netlify.app', 'http://localhost:8080', 'https://movieapi-dcj2.onrender.com/', 'https://johannasah.github.io/myFlix-Angular-client/']; // list of allowed domains
app.use(cors({
